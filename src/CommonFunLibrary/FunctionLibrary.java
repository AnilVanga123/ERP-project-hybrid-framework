...
public class FunctionLibrary {
	...
	if (PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome"))
	{
		...
		System.setProperty("webdriver.chrome.driver","F:\\December_Selenium\\ERP_StockAccounting\\CommonDrivers\\chromedriver.exe");
		driver=new ChromeDriver();
	}
	else if (PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox"))
	{
		System.setProperty("webdriver.gecko.driver", "F:\\December_Selenium\\ERP_StockAccounting\\CommonDrivers\\geckodriver.exe");
...
FileWriter fw= new FileWriter("F:\\December_Selenium\\ERP_StockAccounting\\CaptureData\\snumber.txt");
...
FileReader fr=new FileReader("F:\\December_Selenium\\ERP_StockAccounting\\CaptureData\\snumber.txt");
